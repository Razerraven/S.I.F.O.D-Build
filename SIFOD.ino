...
void loop() {
  ...
  if (getID()){
    ...
    if (ready && inSheet){
      ...
      bool success = GSheet.values.update(&response /* returned response */, "19gHJ14CXwInlk0dg2wJrR4vardE-ZPwwI7-Ef6m0T3w" /* spreadsheet Id to update */, temp /* range to update */, &valueRange /* data to update */);
